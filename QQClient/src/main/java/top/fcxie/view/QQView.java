package top.fcxie.view;

import top.fcxie.service.FileClientService;
import top.fcxie.service.MessageClientService;
import top.fcxie.service.UserClientService;
        ...
        while (loop) {
            ...
            switch (key) {
                case "1":
                    ...
                    if (userClientService.login(userId, pwd)) { //还没有写完, 先把整个逻辑打通....
